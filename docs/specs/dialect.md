...
| directives and nameless containers  | [directives](dialect/directives.md)                               | remark-directive, Pandoc `fenced_divs` | remark, Pandoc for the nameless form | present, `P8`             |
...
| automatic anchors                   | [anchors](dialect/anchors.md)                                     | Pandoc, GFM algorithm                  | Pandoc                               | present                   |
| implicit heading references         | [anchors](dialect/anchors.md)                                     | Pandoc                                 | Pandoc                               | present                   |
...
| citations                           | [citations](dialect/citations.md)                                 | Pandoc                                 | Pandoc                               | present                   |
