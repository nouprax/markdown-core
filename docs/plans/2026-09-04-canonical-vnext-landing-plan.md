...
| `P6`   | `P0`, `M7`         | S    | `^[` before superscript (`O4`)                                                                                                | Pandoc Phase 3 superscript and subscript                                                                                         |
...
| `P11a` | `P0`, `M7`         | M    | caption precedence over term lookahead (`P10`)                                                                                | Pandoc Phase 5 captions                                                                                                          |
