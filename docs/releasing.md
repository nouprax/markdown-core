...
release is `1.0.1`; npm `1.0.0` was the trusted-publisher bootstrap described
below. The repository does not inherit old cmark-gfm tags, and it does not
...
GitHub. The `1.0.1` release must run one OIDC publication and verify the
