...
variant=${1:?usage: create-c-product.sh VARIANT ON|OFF OUTPUT_DIRECTORY [CONFIGURATION]}
shared=${2:?usage: create-c-product.sh VARIANT ON|OFF OUTPUT_DIRECTORY [CONFIGURATION]}
output=${3:?usage: create-c-product.sh VARIANT ON|OFF OUTPUT_DIRECTORY [CONFIGURATION]}
