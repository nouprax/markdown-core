...
for oracle_file in \
    ...
    scripts/correctness/check-ins-parity.mjs \
    scripts/correctness/ins-oracle.mjs \
    scripts/correctness/tests/ins-oracle.test.mjs \
    ...
    scripts/correctness/check-pandoc-parity.mjs \
    scripts/correctness/pandoc-oracle.mjs \
    scripts/correctness/fuzz-scope.mjs \
    scripts/correctness/tests/fuzz-scope.test.mjs \
    scripts/correctness/tests/mdast-oracle.test.mjs \
    scripts/correctness/tests/pandoc-oracle.test.mjs; do
