...
import { median, sameInputGroups, stageComparisons, stageIr } from "./lib/stage-comparisons.mjs";
...
import { currentPairingIdentity, proofWorkload, structuralPair, validatePairs } from "./lib/corpus-pairs.mjs";
...
export function markdownReport(report) {
    ...
    const comparisons = stageComparisons(report);
    const { ranked, roleOf, atScaleOne } = comparisons;
