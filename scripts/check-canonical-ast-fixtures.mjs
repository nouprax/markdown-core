...
const stateValidators = {
    ...
    "list.style.decimal": (tree) => /^.*List scope=.* style=decimal /m.test(tree),
    "list.style.null": (tree) => /^.*List scope=.* style=null /m.test(tree),
    "list.delimiter.period": (tree) => /^.*List scope=.* delimiter=period /m.test(tree),
    "list.delimiter.oneParen": (tree) => /^.*List scope=.* delimiter=oneParen /m.test(tree),
