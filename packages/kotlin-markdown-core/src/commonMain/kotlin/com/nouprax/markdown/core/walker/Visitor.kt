...
public interface Visitor<Result> {
    public fun visitDocument(node: DocumentRoot): Result
    ...
    public fun visitLinkReference(node: LinkReference): Result

    public fun visitImageReference(node: ImageReference): Result
