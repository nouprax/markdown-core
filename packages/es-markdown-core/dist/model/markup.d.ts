...
export type Markup = Semantic | BlockQuote | Paragraph | Heading | ThematicBreak | List | ListItem | CodeBlock | HTMLBlock | FormulaBlock | Table | TableRow | TableCell | DirectiveBlock | DirectiveLabel | FootnoteDefinition | ReferenceDefinition | Text | SoftBreak | LineBreak | Code | HTML | Formula | Emphasis | Strong | Strikethrough | Link | Image | LinkReference | ImageReference | Directive | FootnoteReference;
