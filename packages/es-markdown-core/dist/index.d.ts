...
export type { ImageReference, LinkReference } from "./model/reference.js";
export type { Semantic } from "./model/semantic.js";
...
export type { Identity, ListFlavor, PlacementMode, Position, Scope, TableAlignment } from "./values.js";
