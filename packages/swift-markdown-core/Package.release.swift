...
let package = Package(
    ...
    targets: [
        .target(
            ...
            sources: [
                "core/markdown_core.c", "core/node.c", "core/attributes.c", "core/metadata.c", "core/iterator.c",
                "core/blocks.c",
                ...
                "extensions/autolink.c", "extensions/formula.c", "extensions/comment.c",
                "extensions/cross_link.c", "extensions/directive.c",
