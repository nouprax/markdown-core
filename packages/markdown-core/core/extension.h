...
struct markdown_core_extension {
    ...
    markdown_core_materialize_inline_func materialize_inline;
    const markdown_core_delimiter_rule *delimiter_rules;
    size_t delimiter_rule_count;
    const unsigned char *special_inline_chars;
    size_t special_inline_char_count;
    /* Real source bytes scan_delims treats as transparent when classifying
     * emphasis flanking. Internal rule identity never belongs in this
