...
markdown_core_mem MARKDOWN_CORE_ARENA_MEM_ALLOCATOR = {arena_calloc, arena_realloc, arena_free};

markdown_core_mem *markdown_core_get_arena_mem_allocator(void) { return &MARKDOWN_CORE_ARENA_MEM_ALLOCATOR; }
