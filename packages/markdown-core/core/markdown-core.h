...
typedef enum {
    ...
    /* A private collection root, not a public Markup kind. */
    MARKDOWN_CORE_NODE_DEFINITION_BODY = MARKDOWN_CORE_NODE_TYPE_BLOCK | 0x0014,
    MARKDOWN_CORE_NODE_TABLE_CAPTION = MARKDOWN_CORE_NODE_TYPE_BLOCK | 0x0015,
    ...
    MARKDOWN_CORE_NODE_CROSS_EMBEDDED = MARKDOWN_CORE_NODE_TYPE_INLINE | 0x0013,
    MARKDOWN_CORE_NODE_INSERTION = MARKDOWN_CORE_NODE_TYPE_INLINE | 0x0014,
    MARKDOWN_CORE_NODE_SPAN = MARKDOWN_CORE_NODE_TYPE_INLINE | 0x0015,
    MARKDOWN_CORE_NODE_SUPERSCRIPT = MARKDOWN_CORE_NODE_TYPE_INLINE | 0x0016,
    MARKDOWN_CORE_NODE_SUBSCRIPT = MARKDOWN_CORE_NODE_TYPE_INLINE | 0x0017,
