 ...
 */
MARKDOWN_CORE_EXPORT void markdown_core_consolidate_text_nodes(markdown_core_node *root);

/** Ensures a node and all its children own their own chunk memory.
 */
MARKDOWN_CORE_EXPORT void markdown_core_node_own(markdown_core_node *root);
