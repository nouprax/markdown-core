...
static void source_pos(test_batch_runner *runner) {
    ...
    test_facade_dump(runner, markdown,
                     ...
                     "    └── List scope=6:3..10:20 flavor=ordered start=1 style=decimal delimiter=period tight=false children=2\n"
                     "        ├── ListItem scope=6:3..8:1 marker=null exampleLabel=null children=1\n"
                     ...
                     "        └── ListItem scope=9:3..10:20 marker=null exampleLabel=null children=1\n"
