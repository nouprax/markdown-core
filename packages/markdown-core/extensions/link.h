...
void markdown_core_inline_pop_bracket(markdown_core_inline_parser *subj);
...
void markdown_core_inline_replace_bracket_opener(markdown_core_inline_parser *subj, bracket *opener,
                                                 markdown_core_node *replacement);
void markdown_core_inline_push_bracket(markdown_core_inline_parser *subj, bracket_kind kind,
