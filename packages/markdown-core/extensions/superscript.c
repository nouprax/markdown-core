...
const markdown_core_extension MARKDOWN_CORE_EXTENSION_SUPERSCRIPT = {
    .name = "superscript",
    .delimiter_rule = MARKDOWN_CORE_DELIM_RULE_SUPERSCRIPT,
    .delimiter_character = '^',
    .delimiter = {.minimum_width = 1,
                  .maximum_width = 1,
                  .run_limit = 1,
                  .body = DELIMITER_WORD_BODY,
                  .single_kind = MARKDOWN_CORE_NODE_SUPERSCRIPT},
    .match_inline = match,
    .terminates_text = "^",
    .dispatch = "^",
};
