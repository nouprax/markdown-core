...
#define scan_table_cell_end(c, l, n) markdown_core_ext_scan_at(&markdown_core_scan_table_cell_end, c, l, n)
#define scan_table_row_end(c, l, n) markdown_core_ext_scan_at(&markdown_core_scan_table_row_end, c, l, n)
...
#define scan_formula_latex_backslash_inline_open(c, l, n)                                                              \
    markdown_core_ext_scan_at(&markdown_core_scan_formula_latex_backslash_inline_open, c, l, n)
#define scan_formula_latex_backslash_display_open(c, l, n)                                                             \
    markdown_core_ext_scan_at(&markdown_core_scan_formula_latex_backslash_display_open, c, l, n)
#define scan_directive_name(c, l, n) markdown_core_ext_scan_at(&markdown_core_scan_directive_name, c, l, n)
