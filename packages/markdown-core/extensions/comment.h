...
bool markdown_core_comment_scan_html(markdown_core_inline_parser *subj, bufsize_t pos, unsigned *flags,
                                     bufsize_t *length);
markdown_core_node *markdown_core_comment_make_html(markdown_core_inline_parser *subj, bufsize_t pos, bufsize_t length);
#endif
