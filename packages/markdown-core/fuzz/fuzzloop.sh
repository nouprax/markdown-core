...
do
    ...
    ./packages/markdown-core/fuzz/fuzz_quadratic -merge=1 corpus ../packages/markdown-core/benchmarks corpus2/ -max_len=1024
    rm -r corpus2

    # Run the fuzzer for 4 hours
    date
    echo start fuzzer
    ./packages/markdown-core/fuzz/fuzz_quadratic corpus -dict=../packages/markdown-core/tests/core/fuzzing_dictionary -jobs=$(nproc) -workers=$(nproc) -max_len=1024 -max_total_time=14400
done
